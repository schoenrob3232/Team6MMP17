...
/* 
Das noch unt�tige Ger�st  f�r einen Sliding Window Ansatz.
(Aufgabe1.5)
*/
	...
	while (height >= 134 && width >= 70) {
		...
		for (int i = 0; i < windows_y; i++) {
			for (int j = 0; j < windows_x; j++) {
				...
				/*
				Was auch immer hier in den n�chsten Aufgaben hin soll...
...
groundTruths_ard: enth�lt die Ground truths
(Aufgabe1.5)
*/
