...
/*
	Extrahiert die Traningsdaten aus dem Bild img_arg
	labels: in diesen Mat-Vector werden die labels hineineschrieben
	groundTruths_arg: enthaelt die Groundtruths
	(Aufgabe1.5)
*/
...
/*
	Extrahiert die positiven Traningsdaten aus dem Bild img_arg
	labels: in diesen Mat-Vector werden die labels hineineschrieben
	groundTruths_arg: enth�lt die Groundtruths
	(Aufgabe1.5)
*/
...
/*
	Checks if the proposed location fits at least one ground
	truth in the image (as returned by the method getGroundTruth(string filename))
	over IoU. If so, it returns 'true'.
*/
